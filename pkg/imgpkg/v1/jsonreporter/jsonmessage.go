...
// -- Code reused from https://github.com/moby/moby/blob/da039bf8e6e350bd062c8b596e9379a75e2d4854/pkg/jsonmessage/jsonmessage.go
// Licensed to Docker, Inc. under Apache-2.0

package jsonreporter // import "github.com/docker/docker/pkg/jsonreporter"
...
func DisplayJSONMessagesStream(in io.Reader, out io.Writer, terminalFd uintptr, isTerminal bool, auxCallback func(JSONMessage)) error {
	...
	for {
		...
		// JoaoPereira: Added this if statement because the Error field was not nil, but the struct was empty in
		// our use case, so in the future if we need to update the code from the moby repository we should
		// make sure this fix is added
		if jm.Error != nil {
			if jm.Error.Message == "" && jm.Error.Code == 0 {
				jm.Error = nil
			}
		}
