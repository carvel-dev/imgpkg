...
func (o *CopyOptions) Run() error {
	...
	registry, err := ctlimg.NewRegistry(o.RegistryFlags.AsRegistryOpts(), imagelayers.NewImageLayerWriterCheck(o.IncludeNonDistributableFlag.IncludeNonDistributable), prefixedLogger)
	if err != nil {
